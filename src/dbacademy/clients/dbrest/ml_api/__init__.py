...
from dbacademy.clients.dbrest.ml_api.feature_engineering_api import FeatureEngineeringApi
...
class MlApi(ApiContainer):
    ...
    @property
    def feature_engineering(self) -> FeatureEngineeringApi:
        return FeatureEngineeringApi(self.__client)
